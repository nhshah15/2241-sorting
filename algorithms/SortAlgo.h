...
// Two-moment bracketing sort based on median and variance
class TwoMomentSort : public SortAlgorithm {
public:
    TwoMomentSort() = default;
    void sort(SortGame& game) override;
};

// Simplified version of TwoMomentSort that uses vectors instead of trees
class TwoMomentSort_small : public SortAlgorithm {
public:
    TwoMomentSort_small() = default;
    void sort(SortGame& game) override;
};

class DDS : public SortAlgorithm {
public:
    DDS() = default;
    void sort(SortGame& game) override;
};
